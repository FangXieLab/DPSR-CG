...
def main():
    ...
    if MIA:
        ...
        elif 'DPSUR_GC' == algorithm:
            test_acc, last_iter, best_acc, best_iter, trained_model, iter_list = DPSUR_GC(dataset_name, train_data,
                                                                                       test_data, model, batch_size, lr,
                                                                                       momentum, epsilon, delta, C_t,
                                                                                       sigma_t, use_scattering,
